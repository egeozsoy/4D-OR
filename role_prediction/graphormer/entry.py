...
from role_prediction.graphormer.model import Graphormer
from role_prediction.graphormer.data import GraphDataModule, get_dataset
...
def cli_main():
    ...
    args.replace_sampler_ddp = args.dataset_name != 'role_prediction'
    ...
    if args.checkpoint_path != '':
        model = Graphormer.load_from_checkpoint(
            ...
            role_prediction_save_name=args.role_prediction_save_name,
        )
    else:
        model = Graphormer(
            n_layers=args.n_layers,
