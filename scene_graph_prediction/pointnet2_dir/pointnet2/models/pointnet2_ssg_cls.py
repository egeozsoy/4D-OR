...
import scene_graph_prediction.pointnet2_dir.pointnet2.data.data_utils as d_utils
from scene_graph_prediction.pointnet2_dir.pointnet2.data.ModelNet40Loader import ModelNet40Cls
    ...
    def _build_model(self):
        ...
        self.SA_modules.append(
            PointnetSAModule(
                ...
                radius=0.2,
                nsample=64,
                mlp=[self.input_dim - 3, 64, 64, 128],
                use_xyz=True,
            )
        )
        self.SA_modules.append(
