...
from external_src.group_free_3D.OR_4D.OR_4D_detection_dataset import DC
...
def compute_box_and_sem_cls_loss(end_points, config, num_decoder_layers,
    ...
    for prefix in prefixes:
        ...
        criterion_sem_cls = nn.CrossEntropyLoss(reduction='mean',
                                                weight=DC.class_weights)  # https://discuss.pytorch.org/t/passing-the-weights-to-crossentropyloss-correctly/14731/10
