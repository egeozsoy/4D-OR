...
from voxelpose_lib.core.loss import PerJointL1Loss
from voxelpose_lib.core.loss import PerJointMSELoss
# noinspection PyUnresolvedReferences
from voxelpose_lib.models import pose_resnet
from voxelpose_lib.models.cuboid_proposal_net import CuboidProposalNet
from voxelpose_lib.models.pose_regression_net import PoseRegressionNet
...
class MultiPersonPoseNet(nn.Module):
    def __init__(self, backbone, cfg):
        ...
        self.patient_weight = cfg.LOSS.PATIENT_WEIGHT  # Requires dataset to return patient vs non patient information
