...
from voxelpose_lib.utils.transforms import affine_transform, get_scale
from voxelpose_lib.utils.transforms import get_affine_transform
...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        pcd_idx_str = db_rec.get('pcd_idx_str', None)
        take_idx = db_rec.get('take_idx', None)
        ...
        # visualize_inputs_tensor(input, joints)
        ...
        meta = {
            ...
            'is_patient_mask': is_patient_mask_numpy,
            'take_idx': take_idx
        }
