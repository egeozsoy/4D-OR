...
from group_free_3D.models import APCalculator, parse_predictions, parse_groundtruths
from group_free_3D.models.ap_helper import dump_predictions, dump_ground_truth
from group_free_3D.models import GroupFreeDetector, get_loss
from group_free_3D.utils import setup_logger
...
def parse_option():
    ...
    # Eval
    parser.add_argument('--checkpoint_path', default='group_free_3D/pretrained_model/ckpt_epoch_last.pth',
...
def get_loader(args):
    ...
    if args.dataset == 'OR_4D':
        from group_free_3D.OR_4D.OR_4D_detection_dataset import OR_4DDetectionDataset
        from group_free_3D.OR_4D.model_util_OR_4D import OR_4DDatasetConfig
